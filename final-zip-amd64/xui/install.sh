...
install_x_ui() {
    ...
    echo -e "${GREEN}涓嬭浇 xui ${LATEST_VERSION} (${ARCH})...${PLAIN}"
    ...
    echo -e "${GREEN}xui ${LATEST_VERSION} 瀹夎鎴愬姛锛?{PLAIN}"
    echo -e ""
    echo -e "闈㈡澘璁块棶鍦板潃: ${GREEN}http://鏈嶅姟鍣↖P:54321${PLAIN}"
